...
<title>Osman Chaudhary - Bio</title>
	...
	<div id='wrapper'>
        ...
        <div id='sidebar'>       	
            	...
            	<ul id='navi_prime'>
                    ...
                    <li><a href='#' class='navi_prime_work' title=''>work</a></li>
    	...
    	<div id='content'>
            ...
            <div id='biography'>
                ...
                <span>Osman Chaudhary is a one-of-one character issued in Heidelberg Germany in the mid 1980s. After some adventures in the US and Canada where he taught himself elementary skills in sewing, cutting, draping, and pattern drafting, he returned to Germany to study fashion design at École Superieure des arts et techniques de la Mode Esmod Berlin. He graduated in June 2010.</span>
                <span class='p'>Throughout his time at ESMOD he has worked together with designer Errolson Hugh on Stone Island and the Stone Island Shadow Project. He was part in design, pattern making, usability research, and prototyping/sample making. He was also an active part of the development and decision making processes for fabric developments, and treatments. For his personal work he likes working with classical patterns and tailored silhouettes which he then newly interprets with futuristic design details and articulates with sophisticated material combinations.</span>
                <span class='p'>After further adventures in Berlin Osman started working for the Needles and Pins group in Stockholm, clients included: Acne, HumanScales, Hope&amp;Glory and Whyszeck. Consulting, design, pattern making and production management as well as attelier work were active parts of his work.</span>
                <span class='p'>Currently Osman is back with Errolson Hugh's labratory of exploration, Acronym. Assisting with design for the Stone Island Shadow Project, Herno Laminar, Disearen and Acronym; further solidifying his expertise in advanced sewing techniques, tailoring, construction, cutting, and draping.</span>               
                </div>
            </div><!--biography-->
